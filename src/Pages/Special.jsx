...
export default function Special() {
  return (
    <div className='container font-regu'>
      ...
      <Image className='w-40 h-40 mt-2 m-auto' src='images/sample-reagent-for-sickle.jpg' alt='img' />
      <div className='text-center'>sample & reagent</div>

      <div className='text-xl mt-3'>في حالة كانت النتيجة -ve تترك ال slide ساعتين ثم تعاد قراءتها، وإذا كانت -ve توضع ال slide في betri dish فيه شاش مبلول ثم تعاد قراءته</div>
      <Image className='w-80 h-40 mt-2 m-auto' src='images/sickle-test.jpg' alt='img' />
      <div className='text-center'>sickle test</div>
      <Image className='w-60 h-40 mt-3 m-auto' src='images/sickiling-test.jpg' alt='img' />
      <div className='text-center'>sickiling test 40x</div>
